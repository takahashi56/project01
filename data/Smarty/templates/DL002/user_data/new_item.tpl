...
<div id="undercolumn">
    ...
    <!--★タイトル★-->
    <h2 class="heading-title"><!--{$tpl_subtitle|h}--> <small><span class="attention"><!--{$tpl_linemax}-->件</span>の商品</small></h2>
    ...
    <!--{foreach from=$arrProducts item=arrProduct name=arrProducts}-->
        ...
        <!--{/if}-->
                ...
                <!--▼商品-->
                <div class=" clearfix col-xs-6 col-sm-4 col-md-3 category-lists">
                    <a href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->" class="thumbnail product_list">
                    ...
                    <!--★画像★-->
                        <div class="picture-block-wrap<!--{if $arrSearchData.category_id == 2}--> picture-block-wrap-point<!--{/if}-->"><img src="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$arrProduct.main_list_image|sfNoImageMainList|h}-->" alt="<!--{$arrProduct.name|h}-->" class="picture" /></div>
                        <div class="caption">
                        ...
                        <span class="price">
                            <span id="price02_default_<!--{$id}-->"><!--{strip}-->
                                <!--{if $arrProduct.price02_min_inctax == $arrProduct.price02_max_inctax}-->
                                    <!--{$arrProduct.price02_min_inctax|number_format}--><!--{if $tpl_product_type[$id] == 1}-->円<span class="mini">(税込)<!--{else}-->ポイント<!--{/if}--></span>
                                <!--{else}-->
