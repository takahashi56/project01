...
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/bxslider/jquery.bxslider.min.js"></script>
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/jquery.matchHeight-min.js"></script>
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/slick.js"></script>
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/jquery.ellipsis.min.js"></script>
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/init.js"></script>
<script type="text/javascript" src="<!--{$TPL_URLPATH}-->js/user.js"></script>
...
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->bootstrap/3.3.4/css/bootstrap.css" />
...
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->js/bxslider/jquery.bxslider.css" type="text/css" media="all" />
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->css/style.css" type="text/css" media="all" />
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->css/video.css" type="text/css" media="all" />
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->css/slicknav.css" type="text/css" media="all" />
<link rel="stylesheet" href="<!--{$TPL_URLPATH}-->css/slick.css" type="text/css" media="all" />
...
<script src="<!--{$TPL_URLPATH}-->js/jquery.slicknav.js"></script>
