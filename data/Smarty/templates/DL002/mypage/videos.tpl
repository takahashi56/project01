...
<div id="mypagecolumn">
    ...
    <div class="well">
      ...
      ダウンロードは「購入履歴一覧」の「購入履歴詳細」からご利用いただけます。
            ...
            <div summary="購入商品詳細" class="video-list">
                <!--{foreach from=$tpl_arrOrderDetail item=orderDetail}-->
                    <div class="video-item">
                        ...
                        <video  class="video-js vjs-big-play-centered" controls preload="none" width="180" height="113" poster="<!--{$smarty.const.IMAGE_SAVE_URLPATH}--><!--{$orderDetail.main_list_image|sfNoImageMainList|h}-->"  data-setup="{}">
