...
<div id="system" class="contents-main">
    ...
    <table class="list">
        ...
        <tr bgcolor="<!--{$tr_color}-->">
            ...
            <td align="center"><!--{if $data.discount_type==0 }-->&yen;<!--{$data.discount_price|escape|number_format}--><!--{elseif $data.discount_type==2 }-->加算ポイント<!--{$data.discount_price|escape|number_format}-->pt<!--{else}--><!--{$data.discount_percent|escape}-->%<!--{/if}--></td>
            ...
            <td align="center"><!--{if $data.count_limit==0 }-->無制限<!--{elseif $data.count_limit==2 }-->全体で1回限り<!--{else}-->1回限り<!--{/if}--></td>
