<?php /* Smarty version 2.6.27, created on 2017-08-22 18:49:46
         compiled from /home/oomaekunccb/rchs-studio.com/public_html/video//data/Smarty/templates/admin/products/subnavi.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/home/oomaekunccb/rchs-studio.com/public_html/video//data/Smarty/templates/admin/products/subnavi.tpl', 3, false),)), $this); ?>
...
<li<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_subno'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 'add_product_columns'): ?> class="on"<?php endif; ?> id="navi-products-add-product-columns"><a href="<?php echo ((is_array($_tmp=@PLUGIN_HTML_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
AddProductColumns/admin/products/plg_AddProductColumns_columns.php"><span>商品情報管理</span></a></li></ul>