<?php /* Smarty version 2.6.27, created on 2018-02-23 13:32:55
         compiled from products/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/index.tpl', 39, false),array('modifier', 'h', 'products/index.tpl', 48, false),array('modifier', 'sfGetErrorColor', 'products/index.tpl', 48, false),array('modifier', 'sfNoImageMainList', 'products/index.tpl', 324, false),array('modifier', 'n2s', 'products/index.tpl', 332, false),array('modifier', 'sfTrim', 'products/index.tpl', 358, false),array('modifier', 'count', 'products/index.tpl', 366, false),array('function', 'html_options', 'products/index.tpl', 67, false),array('function', 'html_checkboxes', 'products/index.tpl', 72, false),)), $this); ?>
        ...
        .click(function(){
            if(productsAreSelected()){
                var options = {
                    ...
                    action: '<?php echo ((is_array($_tmp=@PLUGIN_HTML_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
OperateProductSTrial/admin/products/plg_OperateProductSTrial_edit_products.php'
                };
...
unset($_smarty_tpl_vars);
 ...
 <col /><col width="8%"><col width="9%"><col width="9%"><col width="8%"><col width="25%"><col width="8%"><col width="8%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><col width="5%"><tr>
<script type="text/javascript">
$(function(){
    var checkboxes = $('#products-search-result .product-id');
    $('#select-all')
        .click(function(){
...
;"> 
 ...
 <td rowspan="2">
     <input type="checkbox" class="product-id" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
[]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" />
 </td><td class="id" rowspan="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrProducts'][$this->_sections['cnt']['index']]['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
