<?php /* Smarty version 2.6.27, created on 2017-08-30 23:52:34
         compiled from mail/input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/input.tpl', 4, false),array('modifier', 'h', 'mail/input.tpl', 4, false),array('modifier', 'sfGetErrorColor', 'mail/input.tpl', 9, false),array('function', 'html_options', 'mail/input.tpl', 9, false),)), $this); ?>
...
"><?php endif; ?><?php endforeach; endif; unset($_from); ?><input type="hidden" name="mode" value="template"><input type="hidden" name="mail_method" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrForm']['mail_method']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><div id="mail" class="contents-main">
    <table class="form"><tr><th>テンプレート選択<span class="attention"> *</span></th>
            <td>
...
" onchange="return eccube.insertValueAndSubmit( document.form1, 'mode', 'template', '' ) " style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
"><option value="" selected>選択してください</option><?php echo smarty_function_html_options(array('options' => ((is_array($_tmp=$this->_tpl_vars['arrTemplate'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
        ...
        </tr></table><?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['template_id']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><table class="form"><tr><th>Subject<span class="attention"> *</span></th>
            <td>
...
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
        ...
        </tr></table><?php endif; ?><div class="btn-area">
        <ul><li><a class="btn-action" href="javascript:;" onclick="return eccube.insertValueAndSubmit( document.form1, 'mode', 'back', '' ); return false;"><span class="btn-prev">検索画面に戻る</span></a></li>
