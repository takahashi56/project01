<?php /* Smarty version 2.6.27, created on 2017-08-30 23:52:19
         compiled from mail/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail/index.tpl', 5, false),array('modifier', 'default', 'mail/index.tpl', 39, false),array('modifier', 'h', 'mail/index.tpl', 54, false),array('modifier', 'sfDispDBDate', 'mail/index.tpl', 79, false),array('function', 'html_radios', 'mail/index.tpl', 11, false),array('function', 'html_checkboxes', 'mail/index.tpl', 34, false),array('function', 'html_options', 'mail/index.tpl', 44, false),)), $this); ?>
...
"><input type="hidden" name="mode" value="search"><h2>配信先検索条件設定</h2>
...
</span><br><?php endif; ?><?php echo smarty_function_html_radios(array('name' => ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'options' => ((is_array($_tmp=$this->_tpl_vars['arrHtmlmail'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => "&nbsp;",'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']]['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
<br><span class="attention">「全員（メルマガ拒否している会員も含む） 」を選択される場合は、メンテナンス告知など、運用関連の配信のみとして下さい。</span>
            </td>
        </tr><tr>
    <th>会員ランク</th>
    <td colspan="3"><?php echo smarty_function_html_checkboxes(array('name' => 'search_plg_managecustomerstatus_status','options' => ((is_array($_tmp=$this->_tpl_vars['arrPlgManageCustomerStatus'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => "&nbsp;",'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['search_plg_managecustomerstatus_status']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</td>
</tr>
<tr><th>配信メールアドレス種別</th>
            <td colspan="3">
...
<form name="form1" id="form1" method="post" action="?">
    <input type="hidden" name="<?php echo ((is_array($_tmp=@TRANSACTION_ID_NAME)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['transactionid'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
"><input type="hidden" name="mode" value=""><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrHidden'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <!--検索結果表示テーブル-->
        <table class="list"><col width="10%"><col width="25%"><col width="35%"><col width="15%"><col width="15%"><tr><th>会員ID</th>
                <th>名前</th>
                <th>メールアドレス</th>
                <th>希望配信</th>
                <th>登録・更新日</th>
...
?><tr><td class="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrResults'][$this->_sections['i']['index']]['customer_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
 ...
 <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrResults'][$this->_sections['i']['index']]['name02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
            ...
            </tr><?php endfor; endif; ?></table><!--検索結果表示テーブル--><?php endif; ?></form>
