<?php /* Smarty version 2.6.27, created on 2017-10-31 11:17:15
         compiled from order/product_select.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'order/product_select.tpl', 42, false),array('modifier', 'h', 'order/product_select.tpl', 124, false),array('modifier', 'sfNoImageMainList', 'order/product_select.tpl', 177, false),array('modifier', 'sfGetErrorColor', 'order/product_select.tpl', 199, false),array('function', 'html_options', 'order/product_select.tpl', 133, false),)), $this); ?>
...
';
        var shipping_id = '<?php echo ((is_array($_tmp=$this->_tpl_vars['shipping_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
';
...
');
        ...
        if (shipping_id != '') {
            fm1.getElementById("select_shipping_id").value = escape('<?php echo ((is_array($_tmp=$this->_tpl_vars['shipping_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
');
        }
...
" />
    ...
    <input name="shipping_id" type="hidden" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['shipping_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" />
...
を入力して下さい。</span>
                            ...
                            <?php else: ?>
                            <input type="hidden" name="classcategory_id1" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['class1'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="" />
                            <?php endif; ?>
...
を入力して下さい。</span>
                            ...
                            <?php else: ?>
                            <input type="hidden" name="classcategory_id2" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['class2'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="" />
                            <?php endif; ?>
