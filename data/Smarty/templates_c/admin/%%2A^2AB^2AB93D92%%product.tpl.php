<?php /* Smarty version 2.6.27, created on 2018-02-24 01:49:32
         compiled from products/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/product.tpl', 17, false),array('modifier', 'h', 'products/product.tpl', 68, false),array('modifier', 'sfGetErrorColor', 'products/product.tpl', 116, false),array('modifier', 'default', 'products/product.tpl', 162, false),array('modifier', 'cat', 'products/product.tpl', 258, false),array('modifier', 'function_exists', 'products/product.tpl', 306, false),array('modifier', 'sfNoImageMainList', 'products/product.tpl', 356, false),array('function', 'html_options', 'products/product.tpl', 87, false),array('function', 'html_radios', 'products/product.tpl', 91, false),array('function', 'html_checkboxes', 'products/product.tpl', 96, false),)), $this); ?>
...
"><?php endif; ?><?php endforeach; endif; unset($_from); ?><input type="hidden" name="mode" value="edit"><input type="hidden" name="image_key" value=""><input type="hidden" name="down_key" value=""><input type="hidden" name="product_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
"><input type="hidden" name="anchor_key" value=""><input type="hidden" name="select_recommend_no" value=""><input type="hidden" name="has_product_class" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['has_product_class'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['item'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
"><?php endforeach; endif; unset($_from); ?><div id="products" class="contents-main">
    <h2>基本情報</h2>

    <table class="form"><tr><th>商品ID</th>
        ...
        </tr><tr><th>商品名<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?>" size="60" class="box60"><span class="attention"> (上限<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr><tr><th>商品カテゴリ<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?> height: 120px; min-width: 200px;" onchange="" size="10" multiple></select></td>
                        <td style="padding: 15px;">
                            <a class="btn-normal" href="javascript:;" name="on_select" onclick="fnMoveSelect('category_id_unselect','category_id'); return false;">  &lt;- 登録  </a><br><br><a class="btn-normal" href="javascript:;" name="un_select" onclick="fnMoveSelect('category_id','category_id_unselect'); return false;">  削除 -&gt;  </a>
                        </td>
                        <td>
                            <select name="category_id_unselect[]" id="category_id_unselect" onchange="" size="10" style="height: 120px; min-width: 200px;" multiple><?php echo smarty_function_html_options(array('values' => ((is_array($_tmp=$this->_tpl_vars['arrCatVal'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'output' => ((is_array($_tmp=$this->_tpl_vars['arrCatOut'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['category_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</select></td>
                    </tr></table></td>
        </tr><tr><th>公開・非公開<span class="attention"> *</span></th>
            <td>
        ...
        </tr><?php $this->assign('key', 'plg_managecustomerstatus_product_disp'); ?><tr><th>会員ランク別購入不可設定<br><span class="attention">(購入不可にしたいランクにチェック)</span></th>
            <td>
                <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                <?php echo smarty_function_html_checkboxes(array('name' => ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'options' => ((is_array($_tmp=$this->_tpl_vars['arrPlgManageCustomerStatus'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => '&nbsp;&nbsp;'), $this);?>
        ...
        </tr><?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['has_product_class'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == false): ?><tr><th>商品種別<span class="attention"> *</span></th>
            <td>
        ...
        </tr><tr class="type-download"><th>ダウンロード商品ファイル名<span class="attention"> *</span></th>
            <td>
...
<?php endif; ?>" size="60" class="box60"><span class="red"> (上限<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr><tr class="type-download"><?php $this->assign('key', 'down_file'); ?><th>ダウンロード商品用<br>ファイルアップロード<span class="attention"> *</span></th>
            <td>
...
'); return false;">[ファイルの取り消し]</a><br><?php endif; ?><input type="file" name="down_file" size="40" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
...
　(パラメーター DOWNLOAD_EXTENSION)
        ...
        </tr><tr><th>商品コード<span class="attention"> *</span></th>
            <td>
...
文字)</span>
        ...
        </tr><tr><th><?php echo ((is_array($_tmp=@NORMAL_PRICE_TITLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</th>
            <td>
...
;<?php endif; ?>">円
        ...
        </tr><tr><th><?php echo ((is_array($_tmp=@SALE_PRICE_TITLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
;<?php endif; ?>">円
        ...
        </tr><?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['has_product_class'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == false): ?><?php $_from = ((is_array($_tmp=$this->_tpl_vars['arrRankPrices'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?><?php $this->assign('key', "plg_managecustomerstatus_price".($this->_tpl_vars['item']['status_id'])); ?><tr><th><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
価格</th>
            <td>
                <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
...
" size="6" class="box6" maxlength="<?php echo ((is_array($_tmp=@PRICE_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" style="<?php if (((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?>background-color: <?php echo ((is_array($_tmp=@ERR_COLOR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
;<?php endif; ?>">円
                <span class="attention"> (半角数字で入力)</span>
            </td>
        </tr><?php endforeach; endif; unset($_from); ?><?php endif; ?><?php if (((is_array($_tmp=@OPTION_PRODUCT_TAX_RULE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?><tr><th>消費税率<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?>">%
        ...
        </tr><?php endif; ?><tr><th>在庫数<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?>"><input type="checkbox" name="stock_unlimited" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['stock_unlimited'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?> checked <?php endif; ?> onclick="eccube.checkStockLimit('<?php echo ((is_array($_tmp=@DISABLED_RGB)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
');">無制限
            </td>
        </tr><?php endif; ?><tr><th>商品送料</th>
            <td>
...
;<?php endif; ?>">円
        ...
        </tr><tr><th>ポイント付与率<span class="attention"> *</span></th>
            <td>
...
;<?php endif; ?>"><span class="attention"> (半角数字で入力)</span>
            </td>
        </tr><tr><th>メーカー</th>
            <td>
...
文字)</span>
        ...
        </tr><tr><th>検索ワード<br>※複数の場合は、カンマ( , )区切りで入力して下さい</th>
            <td>
...
</textarea><br><span class="attention"> (上限<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr><tr><th>備考欄(SHOP専用)</th>
            <td>
...
文字)</span>
        ...
        </tr><tr><th>一覧-メインコメント<span class="attention"> *</span></th>
            <td>
...
</textarea><br><span class="attention"> (上限<?php echo ((is_array($_tmp=@MTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr><tr><th>詳細-メインコメント<span class="attention">(タグ許可)*</span></th>
            <td>
...
文字)</span>
        ...
        </tr><tr><?php $this->assign('key', 'main_list_image'); ?><th>一覧-メイン画像<br>[<?php echo ((is_array($_tmp=@SMALL_IMAGE_WIDTH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
'); return false;">[画像の取り消し]</a><br><?php endif; ?><input type="file" name="main_list_image" size="40" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
...
'); return false;">アップロード</a>
        ...
        </tr><tr><?php $this->assign('key', 'main_image'); ?><th>詳細-メイン画像<br>[<?php echo ((is_array($_tmp=@NORMAL_IMAGE_WIDTH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" alt="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
">　<a href="" onclick="selectAll('category_id'); eccube.setModeAndSubmit('delete_image', 'image_key', '<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">[画像の取り消し]</a><br><?php endif; ?><input type="file" name="main_image" size="40" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
"><a class="btn-normal" href="javascript:;" name="btn" onclick="selectAll('category_id'); eccube.setModeAndSubmit('upload_image', 'image_key', '<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
'); return false;">アップロード</a>
            </td>
        </tr><tr><?php $this->assign('key', 'main_large_image'); ?><th>詳細-メイン拡大画像<br>[<?php echo ((is_array($_tmp=@LARGE_IMAGE_WIDTH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
'); return false;">アップロード</a>
        ...
        </tr><tr><th>ダウンロードメッセージ<span class="attention">(タグ許可)</span></th>
            <td>
                <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['guide'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                <textarea name="guide" maxlength="<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" style="<?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['guide'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?>background-color: <?php echo ((is_array($_tmp=@ERR_COLOR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
;<?php endif; ?>" cols="60" rows="8" class="area60"><?php echo "\n"; ?>
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['guide'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</textarea><br><span class="attention"> (上限<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr></table>
 
<?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrColumns'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
    <h2>
        追加情報
    </h2>
                    ...
                    <?php if (((is_array($_tmp=$this->_tpl_vars['arrColumn']['type'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == ((is_array($_tmp=@COLUMN_TYPE_TEXT)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                        <th>
                            ...
                            <span class="attention">
                                <?php if (((is_array($_tmp=$this->_tpl_vars['arrColumn']['required'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>
                                    *
                                <?php endif; ?>
                            </span>
                        </th>
                        <td>
                            ...
                            <input type="text" name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" class="box60" maxlength="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrColumn']['max_length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
" />
                            <?php if (strlen ( ((is_array($_tmp=$this->_tpl_vars['arrColumn']['max_length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
                                <span class="attention">
                                    (上限<?php echo ((is_array($_tmp=$this->_tpl_vars['arrColumn']['max_length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)
                                </span>
                            <?php endif; ?>
                        </td>
...
" class="area60" maxlength="<?php echo ((is_array($_tmp=$this->_tpl_vars['arrColumn']['max_length'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" style="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('sfGetErrorColor', true, $_tmp) : SC_Utils_Ex::sfGetErrorColor($_tmp)); ?>
...
<?php endif; ?><?php if (((is_array($_tmp='sfViewAdminOpe')) ? $this->_run_mod_handler('function_exists', true, $_tmp) : function_exists($_tmp)) === TRUE): ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?><?php endif; ?><div class="btn">
    ...
    <?php endif; ?>
    <h2>サブ情報</h2>
    <table class="form"><?php unset($this->_sections['cnt']);
...
?><!--▼商品  <?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
  --><tr><th>詳細-サブタイトル(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)</th>
...
文字)</span>
        ...
        </tr><tr><th>詳細-サブコメント(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
文字)</span>
        ...
        </tr><tr><?php $this->assign('key', "sub_image".($this->_sections['cnt']['iteration'])); ?><th>詳細-サブ画像(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
'); return false;">アップロード</a>
        ...
        </tr><tr><?php $this->assign('key', "sub_large_image".($this->_sections['cnt']['iteration'])); ?><th>詳細-サブ拡大画像(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
'); return false;">アップロード</a>
  ...
  --><?php endfor; endif; ?></table></div>
    ...
    <?php endif; ?>
    <h2>関連商品</h2>
    <table class="form"><!--▼関連商品--><?php unset($this->_sections['cnt']);
$this->_sections['cnt']['name'] = 'cnt';
...
$this->_sections['cnt']['first']      = ($this->_sections['cnt']['iteration'] == 1);
$this->_sections['cnt']['last']       = ($this->_sections['cnt']['iteration'] == $this->_sections['cnt']['total']);
?><?php $this->assign('recommend_no', ($this->_sections['cnt']['iteration'])); ?><tr><?php $this->assign('key', "recommend_id".($this->_sections['cnt']['iteration'])); ?><?php $this->assign('anckey', "recommend_no".($this->_sections['cnt']['iteration'])); ?><th>関連商品(<?php echo ((is_array($_tmp=$this->_sections['cnt']['iteration'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
)<br><?php if (((is_array($_tmp=$this->_tpl_vars['arrRecommend'][$this->_tpl_vars['recommend_no']]['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><img src="<?php echo ((is_array($_tmp=@IMAGE_SAVE_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
" value="1">削除<br><?php $this->assign('key', "recommend_comment".($this->_sections['cnt']['iteration'])); ?><span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr'][$this->_tpl_vars['key']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
...
<br><textarea name="<?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
</textarea><br><span class="attention"> (上限<?php echo ((is_array($_tmp=@LTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        </tr><?php endfor; endif; ?><!--▲関連商品--></table></div>
    <?php endif; ?>
    ...
    <div class="btn-area">
        ...
        <!--▼検索結果へ戻る-->
        <ul><li><a class="btn-action" href="javascript:;" onclick="eccube.changeAction('<?php echo ((is_array($_tmp=@ADMIN_PRODUCTS_URLPATH)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
