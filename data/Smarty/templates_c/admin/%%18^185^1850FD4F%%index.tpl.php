<?php /* Smarty version 2.6.27, created on 2018-02-24 01:32:06
         compiled from customer/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/index.tpl', 38, false),array('modifier', 'h', 'customer/index.tpl', 80, false),array('modifier', 'truncate', 'customer/index.tpl', 170, false),array('function', 'html_checkboxes', 'customer/index.tpl', 42, false),array('function', 'html_options', 'customer/index.tpl', 70, false),array('function', 'mailto', 'customer/index.tpl', 170, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?><tr><th>会員状態</th>
            ...
            <tr>
                <th>会員ランク</th>
                <td colspan="3">   
                        <?php echo smarty_function_html_checkboxes(array('name' => 'search_plg_managecustomerstatus_status','options' => ((is_array($_tmp=$this->_tpl_vars['arrPlgManageCustomerStatus'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)),'separator' => ' ','selected' => ((is_array($_tmp=$this->_tpl_vars['arrForm']['search_plg_managecustomerstatus_status']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <!--検索結果表示テーブル-->
            <table class="list" id="customer-search-result"><col width="8%"><col width="10%">
<col width="10%" />
<col width="20%" /><col width="8%"><col width="30%"><col width="7%"><col width="7%"><tr><th rowspan="2">種別</th>
<th rowspan="2">会員ランク</th>
                    <th>会員ID</th>
...
<td class="center" rowspan="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrPlgManageCustomerStatus'][$this->_tpl_vars['row']['plg_managecustomerstatus_status']])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</td>
