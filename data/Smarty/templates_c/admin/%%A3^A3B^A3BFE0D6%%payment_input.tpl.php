<?php /* Smarty version 2.6.27, created on 2018-01-11 05:52:33
         compiled from basis/payment_input.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'basis/payment_input.tpl', 26, false),array('modifier', 'h', 'basis/payment_input.tpl', 28, false),array('modifier', 'sfGetErrorColor', 'basis/payment_input.tpl', 46, false),)), $this); ?>
...
" />
    ...
    <input type="hidden" name="payment_id" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['tpl_payment_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" />
    <input type="hidden" name="image_key" value="" />
    <input type="hidden" name="fix" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['fix']['value'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" />
...
" />
    ...
    <input type="hidden" name="charge_flg" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['charge_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" />
