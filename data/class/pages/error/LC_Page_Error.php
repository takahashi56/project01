    ...
    public function action()
    {
        ...
        switch ($this->type) {
            case PRODUCT_NOT_FOUND:
                ...
                break;
            case PAGE_ERROR:
                $this->tpl_error='こちらの商品は、下記に該当する商品です。<br>
ご不明な点がございましたら<a href="'.HTTPS_URL.'contact/">お問い合わせ</a>までご連絡ください。<br>
<br>
【Pマーク付プレミアム（フレッシュマン）会員限定商品の場合】<br>
<br>
限定商品のご購入は<a href="'.HTTPS_URL.'user_data/rank/">プレミアム入会</a>（一定数のポイントを保有）が必要です。<br>
条件は下記の<a href="'.HTTPS_URL.'user_data/rank/" target="_blank">会員ランク案内ページ</a>からご確認いただけます。
<a href="'.HTTPS_URL.'user_data/rank/" target="_blank"><img src="/freshman/user_data/packages/DL002/img/picture/cmp.jpg" alt=""></a><br>
<br>
【サンプル動画の場合】<br>
<br>
一般会員の方で2000ポイント以上を保有する必要があります。<br>
<br>
【VIP会員専用商品の場合】<br>
<br>
VIP会員の方で50,000ポイント以上を保有する必要があります。';
                break;
            case CART_EMPTY:
