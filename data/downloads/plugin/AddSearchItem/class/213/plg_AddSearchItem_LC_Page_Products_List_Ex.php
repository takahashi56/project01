...
require_once PLUGIN_UPLOAD_REALDIR . "AddSearchItem/class/plg_AddSearchItem_LC_Page_Products_List.php";

class plg_AddSearchItem_LC_Page_Products_List_Ex extends plg_AddSearchItem_LC_Page_Products_List{
    /**
