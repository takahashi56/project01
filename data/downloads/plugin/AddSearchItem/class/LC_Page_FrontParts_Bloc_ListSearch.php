 ...
 * @version $Id: $
 */
class LC_Page_FrontParts_Bloc_ListSearch extends LC_Page_FrontParts_Bloc_Ex {
    ...
    function action() {
		...
		// 商品ステータスリスト
		$this->arrSTATUS = plg_AddSearchItem_Util::getStatusList();

		$this->fs_enable = plg_AddSearchItem_Util::existsFreeShippingPlg();
