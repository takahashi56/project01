...
<!--{$arrFavorite[cnt].plg_managecustomerstatus_price_min_inctax|number_format}-->
<!--{else}-->
<!--{$arrFavorite[cnt].plg_managecustomerstatus_price_min_inctax|number_format}-->～<!--{$arrFavorite[cnt].plg_managecustomerstatus_price_max_inctax|number_format}-->
<!--{/if}-->
円</span>
<!--{/if}-->