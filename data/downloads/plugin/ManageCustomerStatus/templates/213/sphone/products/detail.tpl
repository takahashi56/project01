...
//]]></script>
                    ...
                    <p class="sale_price" style="color:#0000FF;">
                        <span class="mini"><!--{if $smarty.const.MEMBER_RANK_PRICE_TITLE_MODE == 1}--><!--{$arrCustomerRank[$customer_rank_id]}--><!--{/if}--><!--{$smarty.const.MEMBER_RANK_PRICE_TITLE}-->(税込)：</span>
                        <span class="price" style="color:#0000FF;"><span id="price03_default">
                            <!--{if $arrProduct.plg_managecustomerstatus_price_min_inctax == $arrProduct.plg_managecustomerstatus_price_max_inctax}-->
                                <!--{$arrProduct.plg_managecustomerstatus_price_min_inctax|number_format}-->
                            <!--{else}-->
                                <!--{$arrProduct.plg_managecustomerstatus_price_min_inctax|number_format}-->～<!--{$arrProduct.plg_managecustomerstatus_price_max_inctax|number_format}-->
                            <!--{/if}-->
