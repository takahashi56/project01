        ...
        $.ajax({
            ...
            success: function(result){
                ...
                for (var product_id in result) {
                    ...
                    var priceVale2 = "";
                    //会員価格が範囲か判定
                    if (product.plg_managecustomerstatus_price_min_inctax == product.plg_managecustomerstatus_price_max_inctax) {
                        priceVale2 = product.plg_managecustomerstatus_price_min_tax_format + '円';
                    } else {
                        priceVale2 = product.plg_managecustomerstatus_price_min_tax_format + '～' + product.plg_managecustomerstatus_price_max_tax_format + '円';
                    }
					if(product.plg_managecustomerstatus_price_min_inctax != 0 && product.plg_managecustomerstatus_price_min_inctax != "" && product.plg_managecustomerstatus_price_min_inctax != null){
