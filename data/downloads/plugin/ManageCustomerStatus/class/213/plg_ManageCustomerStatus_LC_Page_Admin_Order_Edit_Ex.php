...
require_once PLUGIN_UPLOAD_REALDIR . "ManageCustomerStatus/class/plg_ManageCustomerStatus_LC_Page_Admin_Order_Edit.php";

class plg_ManageCustomerStatus_LC_Page_Admin_Order_Edit_Ex extends plg_ManageCustomerStatus_LC_Page_Admin_Order_Edit{
    /**
