...
class plugin_update{
   /**
    ...
    function update01($arrPlugin) {
        ...
        copy(DOWNLOADS_TEMP_PLUGIN_UPDATE_DIR . "/LC_Page_FrontParts_Bloc_Up_SellRanking.php", PLUGIN_UPLOAD_REALDIR . $arrPlugin['plugin_code'] . "/LC_Page_FrontParts_Bloc_Up_SellRanking.php");
