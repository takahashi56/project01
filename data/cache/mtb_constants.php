...
/** 一覧画像横 */
define('SMALL_IMAGE_WIDTH', 300);
/** 一覧画像縦 */
define('SMALL_IMAGE_HEIGHT', 224);
/** 通常画像横 */
define('NORMAL_IMAGE_WIDTH', 300);
/** 通常画像縦 */
define('NORMAL_IMAGE_HEIGHT', 300);
/** 通常サブ画像横 */
define('NORMAL_SUBIMAGE_WIDTH', 330);
/** 通常サブ画像縦 */
define('NORMAL_SUBIMAGE_HEIGHT', 456);
/** 拡大サブ画像横 */
define('LARGE_SUBIMAGE_WIDTH', 900);
/** 拡大サブ画像縦 */
define('LARGE_SUBIMAGE_HEIGHT', 900);
/** 画像サイズ制限(KB) */
...
define('TEMPLATE_SIZE', 100000);
/** カテゴリの最大階層 */
define('LEVEL_MAX', 5);
/** 最大カテゴリ登録数 */
define('CATEGORY_MAX', 1000);
/** 管理機能タイトル */
define('ADMIN_TITLE', "Stmingo 管理画面");
/** 編集時強調表示色 */
...
define('DOWNLOAD_EXTENSION', "zip,lzh,jpg,jpeg,gif,png,mp3,pdf,csv,txt,mp4");
/** ダウンロード販売ファイル用サイズ制限(KB) */
define('DOWN_SIZE', 1000000);
/** 1:実商品 2:ダウンロード */
